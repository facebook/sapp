...
class String(Concatenable, TypeEngine[typing_Text]):
    ...
    ) -> Optional[Callable[[Optional[Any]], Optional[str]]]: ...
    @property
...
class Numeric(_LookupExpressionAdapter, TypeEngine[decimal.Decimal]):
    ...
    ) -> Callable[[Union[float, decimal.Decimal]], str]: ...
    @property
    def python_type(self) -> Union[Type[float], Type[decimal.Decimal]]: ...  # type: ignore  # return type incompatible
    def bind_processor(
        self, dialect: Dialect
    ) -> Optional[Callable[[Optional[str]], decimal.Decimal]]: ...
    def result_processor(
        self, dialect: Dialect, coltype: Any
    ) -> Optional[
        Callable[[Optional[Any]], Optional[Union[float, decimal.Decimal]]]
    ]: ...
...
class _Binary(TypeEngine[_BinaryType]):
    ...
    def bind_processor(
        self, dialect: Dialect
    ) -> Optional[Callable[[_BinaryType], Any]]: ...
    def result_processor(
        self, dialect: Dialect, coltype: Any
    ) -> Optional[Callable[[Optional[Any]], Optional[_BinaryType]]]: ...
...
class _Pickler(Protocol):
    if sys.version_info >= (3, 0):
        ...
        def dumps(
            self, obj: Any, protocol: Optional[int] = ..., *, fix_imports: bool = ...
        ) -> bytes: ...
        def loads(
            self,
            bytes_object: bytes,
        ...
        def dump(
            self, obj: Any, file: IO[bytes], protocol: Optional[int] = ...
        ) -> None: ...
...
class PickleType(TypeDecorator[Any]):
    impl: Any = (
        ...
    )  # impl is Type[TypeEngine[LargeBinary]] on the class, but TypeEngine[LargeBinary] on instances
    protocol: int = ...
    pickler: _Pickler = ...
    ...
    def __init__(
        self,
        protocol: int = ...,
        pickler: Optional[_Pickler] = ...,
        comparator: Optional[Callable[[Any, Any], bool]] = ...,
    ) -> None: ...
    def __reduce__(
        self,
    ) -> Tuple[
        Type[PickleType], Tuple[int, None, Optional[Callable[[Any, Any], bool]]]
    ]: ...
    def bind_processor(
        self, dialect: Dialect
...
class Boolean(Emulated, TypeEngine[bool], SchemaType):
    ...
    def literal_processor(
        self, dialect: Dialect
    ) -> Callable[[Optional[bool]], str]: ...
    def bind_processor(
        self, dialect: Dialect
    ) -> Callable[[Optional[bool]], Optional[Union[bool, int]]]: ...
    def result_processor(
        self, dialect: Dialect, coltype: Any
    ) -> Optional[Callable[[Optional[int]], bool]]: ...
...
class Interval(Emulated, _AbstractInterval[timedelta], TypeDecorator[timedelta]):  # type: ignore
    impl: Any = (
        ...
    )  # impl is Type[TypeEngine[DateTime]] on the class, but TypeEngine[DateTime] on instances
    epoch: datetime = ...
    native: bool = ...
    ...
    def bind_processor(
        self, dialect: Dialect
    ) -> Callable[[Optional[timedelta]], str]: ...
    def result_processor(
        self, dialect: Dialect, coltype: Any
    ) -> Callable[[Optional[str]], Optional[timedelta]]: ...
...
class JSON(Indexable, TypeEngine[_JSONT]):
    ...
    def bind_processor(
        self, dialect: Dialect
    ) -> Callable[[Optional[_JSONT]], Optional[str]]: ...
    def result_processor(
        self, dialect: Dialect, coltype: Any
    ) -> Callable[[Optional[str]], Optional[_JSONT]]: ...
...
class ARRAY(Indexable, Concatenable, TypeEngine[List[_T]]):
    ...
    def compare_values(
        self, x: Any, y: Any
    ) -> bool: ...  # this function just does a simple comparison
