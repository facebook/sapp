...
class TypeEngine(Visitable, Generic[_T_co]):
    ...
    def column_expression(
        self, colexpr: Union[str, ColumnElement[Any]]
    ...
    def with_variant(
        self, type_: Union[TypeEngine[_U], Type[TypeEngine[_U]]], dialect_name: str
    ) -> Variant[_U]: ...
...
class TypeDecorator(SchemaEventTarget, TypeEngine[_T]):
    ...
    def process_bind_param(
        self, value: Optional[_T], dialect: Dialect
    ) -> Optional[typing_Text]: ...
    def process_result_value(
        self, value: Optional[Any], dialect: Dialect
    ) -> Optional[_T]: ...
    def literal_processor(
        self, dialect: Dialect
    ) -> Callable[[Optional[_T]], Optional[str]]: ...
    def bind_processor(
        self, dialect: Dialect
    ) -> Callable[[Optional[_T]], Optional[str]]: ...
    def result_processor(
        self, dialect: Dialect, coltype
    ) -> Callable[[Optional[Any]], Optional[_T]]: ...
    def coerce_compared_value(
        self: _TD, op: Any, value: Any
    ) -> Union[_TD, TypeEngine[Any]]: ...
...
class Variant(TypeDecorator[_T]):
    mapping: Any = ...
    def __init__(
        self, base: TypeEngine[_T], mapping: Mapping[str, TypeEngine[Any]]
    ) -> None: ...
    def coerce_compared_value(
        self: _VT, operator: Any, value: Any
    ) -> Union[_VT, TypeEngine[_T]]: ...
    def load_dialect_impl(self, dialect: Dialect) -> TypeEngine[Any]: ...
    def with_variant(
        self, type_: Union[TypeEngine[_U], Type[TypeEngine[_U]]], dialect_name: str
    ) -> Variant[_U]: ...
...
@overload
def to_instance(
    typeobj: Type[TypeEngine[_T]], *arg: Any, **kw: Any
) -> TypeEngine[_T]: ...
@overload
