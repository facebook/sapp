...
class TestShardedFiles(unittest.TestCase):
    ...
    def test_returns_two_shards_for_two(self) -> None:
    ...
    def test_returns_two_shards_for_two_ambiguous(self) -> None:
    ...
    def test_returns_two_shards_for_one_ambiguous(self) -> None:
    ...
    def test_fails_for_inconsistent_set_star(self) -> None:
